...
let crossIcon = '<div class="icon cross"><i class="fas fa-check"></i></div>';
    ...
    if(userAns == correctAns){
        ...
        for (let i = 0; i < allOptions; i++){
            if(option_list.children[i].textContent == correctAns){
                ...
                option_list.children.insertAdjacentHTML("beforeend", tickIcon);
            }
        }
    }
...
funtion bottom_que_counter(index){
